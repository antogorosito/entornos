...
El pago se realiza en el momento de la entrega del pedido, solo se especifica previamente
si se paga en efectivo o con tarjeta de modo de que se lleve el posnet al domicilio del cliente.
¿Los pedidos sólo pueden ser realizados por internet?
Para entrega a domicilio solo se pueden realizar compras online.
¿Cuáles son los días y horarios de entrega de pedidos?
El cliente especifica el horarios y dia de entrega cuando realiza el pedido,
pero solo se entrega de 8 a 13hs.
¿Puedo realizar un pedido fuera del horario de entrega? 
Si,el pedido queda guardado y se envia en la fecha y hora especificada.
¿Cual es el costo de envio?
El costo es fijo de 200$, sin importar las distancias ni la cantidad de productos.
¿Necesito tener un usuario registrado para realizar un pedido?
Si, se piden datos basicos para tener un registro de quien realiza el pedido.
